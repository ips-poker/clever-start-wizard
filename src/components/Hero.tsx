...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      ></div>
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900/90 via-slate-800/80 to-slate-900/95"></div>
          ...
          <div className="text-white space-y-10 animate-fade-in order-2 lg:order-1">
            <div className="space-y-8 animate-slide-up [animation-delay:0.2s]">
              ...
              <div className="flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left space-y-6 lg:space-y-0 lg:space-x-8 animate-slide-right [animation-delay:0.6s]">
                <div className="w-24 h-24 bg-slate-800/60 backdrop-blur-xl rounded-2xl border border-slate-600/50 shadow-2xl flex items-center justify-center p-4 animate-scale-in [animation-delay:0.3s] flex-shrink-0">
                  <img 
                    src={ipsLogo} 
                    alt="IPS Logo" 
              ...
              <div className="grid grid-cols-3 gap-4 md:gap-6 pt-8 animate-slide-up [animation-delay:1.4s] max-w-2xl mx-auto lg:mx-0">
                 <div className="text-center p-4 md:p-5 bg-slate-800/60 backdrop-blur-xl rounded-xl border border-slate-600/50 shadow-lg transition-all duration-300 hover:scale-105 hover:bg-slate-700/60">
                   <div className="text-3xl md:text-4xl font-bold text-slate-300 mb-2 md:mb-3">500+</div>
                   <div className="text-xs md:text-sm text-slate-400 font-medium">Игроков</div>
                 </div>
                 <div className="text-center p-4 md:p-5 bg-slate-800/60 backdrop-blur-xl rounded-xl border border-slate-600/50 shadow-lg transition-all duration-300 hover:scale-105 hover:bg-slate-700/60">
                   <div className="text-3xl md:text-4xl font-bold text-slate-300 mb-2 md:mb-3">150+</div>
                   <div className="text-xs md:text-sm text-slate-400 font-medium">Турниров</div>
                 </div>
                 <div className="text-center p-4 md:p-5 bg-slate-800/60 backdrop-blur-xl rounded-xl border border-slate-600/50 shadow-lg transition-all duration-300 hover:scale-105 hover:bg-slate-700/60">
                   <div className="text-3xl md:text-4xl font-bold text-slate-300 mb-2 md:mb-3">24/7</div>
                   <div className="text-xs md:text-sm text-slate-400 font-medium">Поддержка</div>
                 </div>
              </div>
           </div>
           ...
           <div className="space-y-6 animate-slide-right [animation-delay:0.4s] order-1 lg:order-2">
               {/* Main Feature Card */}
               <Card className="p-8 bg-slate-800/60 backdrop-blur-xl border border-slate-600/50 shadow-lg hover:scale-105 transition-all duration-300 hover:shadow-xl">
                 <div className="text-center space-y-6">
                   <div className="w-20 h-20 bg-slate-700 rounded-2xl flex items-center justify-center mx-auto shadow-lg text-slate-200">
                     <Timer className="w-10 h-10" />
                   </div>
                   <h3 className="text-2xl lg:text-3xl font-bold text-slate-200">Турнирный таймер</h3>
                   <p className="text-slate-300 text-base lg:text-lg font-medium">Профессиональная система управления временем и блайндами турнира</p>
                   <Badge className="bg-slate-600 text-slate-200 px-6 py-3 font-semibold text-sm lg:text-base shadow-lg">
                     Ключевая функция
                   </Badge>
                 </div>
               </Card>
              ...
              <div className="grid gap-4 md:gap-6">
               <Card className="p-6 bg-slate-800/60 backdrop-blur-xl border border-slate-600/50 hover:border-slate-500/50 transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-xl animate-fade-in [animation-delay:0.8s]">
                 <div className="flex items-center space-x-4">
                   <div className="p-3 lg:p-4 bg-slate-700 rounded-xl shadow-lg flex-shrink-0">
                     <Users className="w-5 h-5 lg:w-6 lg:h-6 text-slate-200" />
                   </div>
                   <div className="text-slate-200 min-w-0">
                     <h3 className="font-bold text-base lg:text-lg">Управление игроками</h3>
                     <p className="text-sm lg:text-base text-slate-400 font-medium">Регистрация и контроль участников</p>
                   </div>
                 </div>
               </Card>

               <Card className="p-6 bg-slate-800/60 backdrop-blur-xl border border-slate-600/50 hover:border-slate-500/50 transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-xl animate-fade-in [animation-delay:1s]">
                 <div className="flex items-center space-x-4">
                   <div className="p-3 lg:p-4 bg-slate-700 rounded-xl shadow-lg flex-shrink-0">
                     <Settings className="w-5 h-5 lg:w-6 lg:h-6 text-slate-200" />
                   </div>
                   <div className="text-slate-200 min-w-0">
                     <h3 className="font-bold text-base lg:text-lg">Настройка структуры</h3>
                     <p className="text-sm lg:text-base text-slate-400 font-medium">Блайнды, выплаты, правила</p>
                   </div>
                 </div>
               </Card>

               <Card className="p-6 bg-slate-800/60 backdrop-blur-xl border border-slate-600/50 hover:border-slate-500/50 transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-xl animate-fade-in [animation-delay:1.2s]">
                 <div className="flex items-center space-x-4">
                   <div className="p-3 lg:p-4 bg-slate-700 rounded-xl shadow-lg flex-shrink-0">
                     <Trophy className="w-5 h-5 lg:w-6 lg:h-6 text-slate-200" />
                   </div>
                   <div className="text-slate-200 min-w-0">
                     <h3 className="font-bold text-base lg:text-lg">Рейтинг ELO</h3>
                     <p className="text-sm lg:text-base text-slate-400 font-medium">Автоматический расчет рейтинга</p>
                   </div>
                 </div>
               </Card>
              </div>
