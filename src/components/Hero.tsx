...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-poker-charcoal/70"></div>
        <div className="absolute inset-0 bg-gradient-overlay"></div>
      </div>
      {/* Subtle Floating Elements */}
      <div className="absolute inset-0 opacity-10 overflow-hidden">
        <div className="absolute top-20 left-10 text-6xl text-white/30">♠</div>
        <div className="absolute top-40 right-20 text-5xl text-white/20">♥</div>
        <div className="absolute bottom-40 left-20 text-6xl text-white/30">♦</div>
        <div className="absolute bottom-20 right-10 text-5xl text-white/20">♣</div>
        
        <div className="absolute top-32 left-1/3 text-4xl text-white/15">♠</div>
        <div className="absolute bottom-32 right-1/3 text-4xl text-white/15">♣</div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8 animate-fade-in">
            <div className="space-y-6">
              <Badge className="bg-white/10 border border-white/30 text-white font-semibold px-5 py-2 rounded-full shadow-subtle backdrop-blur-md">
             ...
             <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-poker-accent text-white hover:bg-poker-accent/90 transition-all duration-300 font-semibold px-8 py-4 text-lg rounded-xl shadow-card">
                  <Play className="w-6 h-6 mr-3" />
                  Начать играть
                </Button>
                <Button size="lg" variant="outline" className="border-2 border-white/50 text-white bg-white/10 hover:bg-white/20 hover:text-white transition-all duration-300 font-semibold px-8 py-4 text-lg rounded-xl backdrop-blur-md shadow-card">
                  Рейтинг игроков
                </Button>
             </div>
             ...
             <div className="grid grid-cols-3 gap-6 pt-8">
                <div className="text-center p-5 bg-white/8 backdrop-blur-xl rounded-xl border border-white/20 shadow-card transition-all duration-300">
           ...
           <div className="space-y-6">
              {/* Main Feature Card */}
              <Card className="p-8 bg-white/8 backdrop-blur-xl border border-white/20 shadow-card">
             ...
             <div className="grid gap-6">
              <Card className="p-6 bg-white/8 backdrop-blur-xl border border-white/20 hover:border-white/30 transition-all duration-300 shadow-card">
