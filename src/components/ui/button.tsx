  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "bg-poker-primary text-poker-text-inverse shadow-card hover:shadow-elevated hover:bg-poker-primary-light font-semibold",
        accent: "bg-poker-accent text-poker-text-inverse shadow-subtle hover:shadow-card hover:bg-poker-accent-light",
        success: "bg-poker-success text-poker-text-inverse shadow-subtle hover:shadow-card hover:bg-poker-success/90",
        elegant: "bg-poker-surface border border-poker-border text-poker-text-primary hover:bg-poker-surface-elevated hover:border-poker-accent shadow-minimal hover:shadow-subtle backdrop-blur-xl",
      },
      size: {
