...
import { Settings, Plus, Edit, Save, X, Mail, Globe, Palette } from "lucide-react";
...
export function SettingsManager() {
  ...
  const resetForm = () => {
    setFormData({
      ...
      category: 'general', description: '', is_public: true
    });
  };
  ...
  const renderSettingValue = (setting: SettingsItem) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {showAddForm && (
        <Card>
          <CardHeader><CardTitle>Новая настройка</CardTitle></CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select value={formData.setting_type} onValueChange={(value) => setFormData({ ...formData, setting_type: value })}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    {settingTypes.map((type) => <SelectItem key={type.value} value={type.value}>{type.label}</SelectItem>)}
                  </SelectContent>
                </Select>
              </div>
              <div className="flex items-center space-x-2">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-start">
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            <Badge variant="outline" className="font-mono text-xs">{setting.setting_key}</Badge>
