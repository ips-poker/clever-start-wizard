  ...
  const renderHome = () => <div className="space-y-4 pb-20 px-4 bg-transparent min-h-screen relative z-10">
      ...
      <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-0 overflow-hidden cursor-pointer hover:from-gray-700 hover:to-gray-800 transition-all duration-300 relative" onClick={() => setActiveTab('rating')}>
        <div className="absolute inset-0 opacity-3 overflow-hidden pointer-events-none">
          <div className="absolute top-2 right-2 text-white transform rotate-12" style={{WebkitTextStroke: '2px white', WebkitTextFillColor: 'transparent', fontSize: '18rem'}}>♠</div>
          <div className="absolute bottom-2 left-2 text-white transform -rotate-12" style={{WebkitTextStroke: '2px white', WebkitTextFillColor: 'transparent', fontSize: '15rem'}}>♣</div>
        </div>
        <CardContent className="p-6 relative z-10">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-0 cursor-pointer hover:from-gray-700 hover:to-gray-800 transition-all duration-300 relative overflow-hidden" onClick={() => setActiveTab('qa')}>
          <div className="absolute inset-0 opacity-3 overflow-hidden pointer-events-none">
            <div className="absolute top-1 right-1 text-white transform rotate-12" style={{WebkitTextStroke: '2px white', WebkitTextFillColor: 'transparent', fontSize: '15rem'}}>♠</div>
            <div className="absolute bottom-1 left-1 text-white transform -rotate-12" style={{WebkitTextStroke: '2px white', WebkitTextFillColor: 'transparent', fontSize: '12rem'}}>♣</div>
          </div>
      ...
      <div>
        ...
        <Card className="bg-gradient-to-br from-red-600 to-red-800 border-0 overflow-hidden cursor-pointer hover:from-red-500 hover:to-red-700 transition-all duration-300 relative" onClick={() => setActiveTab('tournaments')}>
          <div className="absolute inset-0 opacity-2 overflow-hidden pointer-events-none">
            <div className="absolute top-2 right-2 text-red-300 transform rotate-12" style={{WebkitTextStroke: '2px #fca5a5', WebkitTextFillColor: 'transparent', fontSize: '21rem'}}>♥</div>
            <div className="absolute bottom-2 left-2 text-red-300 transform -rotate-12" style={{WebkitTextStroke: '2px #fca5a5', WebkitTextFillColor: 'transparent', fontSize: '18rem'}}>♦</div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transform rotate-45" style={{WebkitTextStroke: '1px #fca5a5', WebkitTextFillColor: 'transparent', opacity: '0.1', fontSize: '24rem'}}>♥</div>
          </div>
          <CardContent className="p-6 relative z-10">
