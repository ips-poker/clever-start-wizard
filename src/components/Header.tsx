  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-background/95 backdrop-blur-sm border-b border-border/50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="relative">
              ...
              <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-card group-hover:shadow-floating transition-all duration-500 border border-border/20 group-hover:border-poker-accent/40">
                <img 
            ...
            <div className="flex flex-col">
              <span className="text-2xl font-black text-poker-accent tracking-tight">
                IPS
              </span>
          ...
          <div className="hidden md:flex items-center space-x-3">
            <Button variant="ghost" size="sm" className="hover:bg-poker-primary/10 hover:text-poker-primary transition-all duration-300 font-medium">
              Войти
            </Button>
            <Button size="sm" className="bg-gradient-button text-white hover:shadow-elevated transition-all duration-300 font-semibold">
              Регистрация
            </Button>
          </div>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 right-0 bg-background/95 backdrop-blur-sm border-b border-border/50 shadow-card">
