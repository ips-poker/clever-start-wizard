...
const TournamentListSkeleton = () => (
  <section className="py-20 bg-gradient-to-br from-slate-900 via-black to-slate-800 relative overflow-hidden">
    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-5">
      <div className="absolute top-10 left-10 text-amber-400/30 text-5xl animate-pulse">♠</div>
      <div className="absolute top-20 right-20 text-amber-400/20 text-4xl animate-bounce-subtle">♣</div>
      <div className="absolute bottom-10 left-20 text-amber-400/25 text-6xl animate-pulse">♥</div>
      <div className="absolute bottom-20 right-10 text-amber-400/20 text-3xl animate-bounce-subtle">♦</div>
    </div>
