...
import { Mic, MicOff, Volume2, VolumeX, MessageCircle, BarChart3, Settings, Bell } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Профессиональное голосовое управление
          </CardTitle>
        </CardHeader>
      ...
      <Tabs defaultValue="control" className="w-full">
        ...
        <TabsContent value="control" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">Управление турниром:</p>
                ...
                {/* Блайнды и время */}
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">Блайнды и время:</p>
                  <div className="grid grid-cols-2 gap-2">
                    <Button 
                      variant="outline" 
                      size="sm"
                ...
                {/* Игроки */}
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">Игроки:</p>
                  <div className="grid grid-cols-2 gap-2">
                    <Button 
                      variant="outline" 
                      size="sm"
          ...
          <Card>
            <CardHeader>
              <CardTitle>Профессиональные голосовые команды</CardTitle>
            </CardHeader>
            <CardContent>
