  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-10">
        ...
        <div className="absolute top-30 right-20 text-amber-400/30 text-4xl animate-bounce-subtle transform -rotate-12">♠</div>
        <div className="absolute bottom-10 left-20 text-amber-400/35 text-6xl animate-pulse transform rotate-45">♣</div>
        <div className="absolute bottom-30 right-10 text-amber-400/30 text-3xl animate-bounce-subtle transform -rotate-30">♦</div>
      </div>
