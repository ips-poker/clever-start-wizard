  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-10">
        <div className="absolute top-10 left-10 text-amber-400/40 text-4xl animate-pulse">♠</div>
        <div className="absolute top-20 right-20 text-amber-400/30 text-3xl animate-bounce-subtle">♣</div>
        <div className="absolute bottom-10 left-20 text-amber-400/35 text-5xl animate-pulse">♥</div>
        <div className="absolute bottom-20 right-10 text-amber-400/30 text-2xl animate-bounce-subtle">♦</div>
      </div>
