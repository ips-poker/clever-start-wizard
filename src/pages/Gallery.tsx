  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background relative overflow-hidden">
        ...
        {/* Neon glows */}
        <div className="fixed top-0 right-1/3 w-[520px] h-[520px] bg-syndikate-orange/25 rounded-full blur-[160px] opacity-80 animate-pulse" />
        <div className="fixed bottom-0 left-1/3 w-[520px] h-[520px] bg-syndikate-red/20 rounded-full blur-[160px] opacity-80 animate-pulse" />
