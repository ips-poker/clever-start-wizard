...
export const config = {
  ...
  // Tournament: 25s base, 60s time bank (PokerStars-style)
  ...
  tournamentActionTimeSeconds: parseInt(process.env.TOURNAMENT_ACTION_TIME_SECONDS || '25', 10), // PokerStars Tournament: 25s
